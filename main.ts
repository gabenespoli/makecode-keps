...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    info.setLife(3)
    info.setScore(0)
    mySprite = sprites.create(assets.image`Red Link`, SpriteKind.Player)
    ...
    mySprite4 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Orb)
    mySprite2.follow(mySprite, randint(1, 5))
    mySprite3.follow(mySprite, randint(6, 10))
    mySprite.setPosition(153, 0)
    mySprite4.setPosition(40, 40)
    mySprite.setStayInScreen(true)
    controller.moveSprite(mySprite)
})
sprites.onDestroyed(SpriteKind.Orb, function (sprite) {
    mySprite4 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 6 6 6 6 . . . . . . 
        . . . . 6 6 6 5 5 6 6 6 . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Orb)
    mySprite4.setPosition(randint(0, 144), randint(0, 104))
})
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Player, function (sprite, otherSprite) {
    mySprite5 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Heart)
    mySprite.setPosition(randint(0, 144), randint(0, 104))
